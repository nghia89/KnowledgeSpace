...
// OnDestroy là dùng để khi chuyển bàn hình thì sẽ unsubscribe hết all connect đến api tránh tràn bộ nhớ
export class PermissionsComponent implements OnInit, OnDestroy {
  ...
  selectAll(checked: boolean, uniqueCode: string) {
    if (uniqueCode === SystemConstants.VIEW_ACTION) {
      ...
      } else { this.selectedViews.length = 0; }
      ...
      } else { this.selectedCreates.length = 0; }
